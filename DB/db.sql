...
-- mar. 05 sept. 2017 09:16:49 CEST
...
CREATE TABLE IF NOT EXISTS `Helloplatdy`.`Discount_code_has_User` (
  ...
  `id_user` INT NOT NULL,
  PRIMARY KEY (`id_discount_code`, `id_user`),
  INDEX `fk_Discount_code_has_User_User1_idx` (`id_user` ASC),
  INDEX `fk_Discount_code_has_User_Discount_code1_idx` (`id_discount_code` ASC),
  CONSTRAINT `fk_Discount_code_has_User_Discount_code1`
    FOREIGN KEY (`id_discount_code`)
    REFERENCES `Helloplatdy`.`Discount_code` (`id_discount_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
